...
class RegistrationForm(FlaskForm):
    ...
    password = PasswordField('Password',
        validators=[DataRequired(), Length(6, 18), EqualTo('password2', message='Password must match.')])
...
class ChangePasswordForm(FlaskForm):
    old_password = PasswordField('Old password', validators=[DataRequired(), Length(6, 18)])
